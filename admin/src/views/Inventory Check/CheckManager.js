...
import CheckTableResult from './CheckTableResult';
...
function CheckManager() {
    ...
    return (
      <>
        <CheckTableResult value={tableValues} selectValue={setModalValue } />
        ...
        <CheckModal type={showModal} setShowModal={setShowModal} data={data} />
      </>
    )
}
